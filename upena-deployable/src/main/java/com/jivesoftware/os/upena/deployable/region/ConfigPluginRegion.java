...
public class ConfigPluginRegion implements PageRegion<ConfigPluginRegionInput> {
    ...
    public void modified(String user, Map<String, Map<String, String>> property_InstanceKey_Values) throws Exception {
        ...
        sb.append("<ul>");
        for (String property : property_InstanceKey_Values.keySet()) {
            sb.append("<li>").append(property).append("</li>");
            sb.append("<li><ul>");
            for (Entry<String, String> keyValue : property_InstanceKey_Values.get(property).entrySet()) {
                sb.append("<li>");
    ...
    public String render(String user, ConfigPluginRegionInput input) {
        ...
        try {
            ...
            data.put("healthProperty", input.healthProperty);
