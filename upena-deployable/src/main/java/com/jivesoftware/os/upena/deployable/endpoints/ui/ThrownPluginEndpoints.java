...
import com.jivesoftware.os.upena.deployable.region.ThrownPluginRegion.ThrownPluginRegionInput;
...
@Singleton
@Path("/ui/thrown")
public class ThrownPluginEndpoints {

    private final ShiroRequestHelper shiroRequestHelper;
    private final SoyService soyService;
    private final ThrownPluginRegion pluginRegion;

    public ThrownPluginEndpoints(@Context ShiroRequestHelper shiroRequestHelper,
        @Context SoyService soyService,
        @Context ThrownPluginRegion pluginRegion) {
