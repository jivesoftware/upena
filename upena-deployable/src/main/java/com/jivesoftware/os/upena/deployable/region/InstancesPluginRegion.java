...
public class InstancesPluginRegion implements PageRegion<InstancesPluginRegionInput> {
    ...
    private void handleCancelRestartAll(Map<String, Object> data, String user, InstanceFilter filter) throws Exception {
        ...
        if (!canceled.isEmpty()) {
            ...
            upenaStore.recordChange(user, "cancelRestart", System.currentTimeMillis(), "", "instance-ui", canceled.toString());
    ...
    private void handleEnable(Map<String, Object> data, String user, InstanceFilter filter) throws Exception {
        ...
        if (!enable.isEmpty()) {
            ...
            upenaStore.recordChange(user, "enabled", System.currentTimeMillis(), "", "instance-ui", enable.toString());
        }
    }
    ...
    private void handleSSL(Map<String, Object> data, String user, InstanceFilter filter, boolean state) throws Exception {
        ...
        if (!enable.isEmpty()) {
            ...
            upenaStore.recordChange(user, "SSL=" + state, System.currentTimeMillis(), "", "instance-ui", enable.toString());
        }
    }
    ...
    private void handleSAUTH(Map<String, Object> data, String user, InstanceFilter filter, boolean state) throws Exception {
        ...
        if (!enable.isEmpty()) {
            ...
            upenaStore.recordChange(user, "SAUTH=" + state, System.currentTimeMillis(), "", "instance-ui", enable.toString());
        }
    }
    ...
    private void handleDisable(Map<String, Object> data, String user, InstanceFilter filter) throws Exception {
        ...
        if (!disabled.isEmpty()) {
            ...
            upenaStore.recordChange(user, "disabled", System.currentTimeMillis(), "", "instance-ui", disabled.toString());
        }
    }
    ...
    private void handleRestartAll(Map<String, Object> data, String user, InstanceFilter filter) throws Exception {
        ...
        if (!restart.isEmpty()) {
            ...
            upenaStore.recordChange(user, "restart", System.currentTimeMillis(), "", "instance-ui", restart.toString());
        }
    }
        ...
        if (input.key.isEmpty()) {
            ...
            try {
                ...
                if (removing != null) {
                    ...
                    upenaStore.recordChange(user, "removed", System.currentTimeMillis(), "", "instance-ui", removing.toString());
    ...
    private void handleAdd(String user, InstancesPluginRegionInput input, Map<String, Object> data) {
        try {
            ...
            if (valid) {
                ...
                upenaStore.recordChange(user, "added", System.currentTimeMillis(), "", "instance-ui",
    ...
    private void handleRestart(String user, InstancesPluginRegionInput input, Map<String, Object> data) {
        try {
            ...
            if (instance == null) {
                ...
                upenaStore.recordChange(user, "restart", System.currentTimeMillis(), "", "instance-ui", instanceToHumanReadableString(instance));
        ...
        try {
            ...
            if (instance == null) {
                ...
                if (valid) {
                    ...
                    upenaStore.recordChange(user, "updated", System.currentTimeMillis(), "", "instance-ui", instanceToHumanReadableString(instance) + "\n"
